...
var abspath = `/Users/debs/Personal/start_with_go/web-dev/hands_on_template/002_practice`
func init() {
	tpl = template.Must(template.ParseFiles(abspath+"/xtemplate.gohtml"))
}
